...
const {from_mail,from_name,to_mail,to_name,text_part,html_cambioContraseña,custom_id} = require("../common/sentEmail");
...
router.post("/rememberPassword", async (req,res) => {
    ...
    try{
        ...
        if(userExist.data.exists){
            ...
            await mailjet.sendEmail(from_mail,from_name,to_mail,to_name,subject,text_part,html_cambioContraseña,custom_id);
...
router.post("/register", async (req,res) => {
    ...
    try{
        ...
        await mailjet.sendEmail(from_mail,from_name,to_mail,to_name,subject,text_part,html_usuarioCreado,custom_id);
